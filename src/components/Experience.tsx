      ...
      <div className="relative border-l border-slate-200 pl-4 dark:border-slate-800">
        {experienceItems.map((item, index) => (
          <motion.article
            ...
            className="relative mb-5 rounded-xl border border-slate-200/80 bg-white/70 p-4 shadow-sm backdrop-blur dark:border-slate-800 dark:bg-slate-900/70"
          >
            <div className="absolute -left-[1.34rem] top-6 h-3 w-3 rounded-full border-4 border-white bg-sky-500 dark:border-slate-950" />
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-[0.3em] text-sky-500">{item.period}</p>
