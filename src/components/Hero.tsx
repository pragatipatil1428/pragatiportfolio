      ...
      <div className="grid items-center gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:gap-14">
        ...
        >
          ...
          <motion.span
            ...
            className="absolute -left-6 top-10 rounded-full border border-slate-200 bg-white/90 px-3 py-1.5 text-xs font-semibold text-sky-700 shadow-lg backdrop-blur dark:border-slate-700 dark:bg-slate-900/90 dark:text-sky-300"
          >
            ⚛️ React
          </motion.span>
          <motion.span
            ...
            className="absolute -right-4 top-1/3 rounded-full border border-slate-200 bg-white/90 px-3 py-1.5 text-xs font-semibold text-violet-700 shadow-lg backdrop-blur dark:border-slate-700 dark:bg-slate-900/90 dark:text-violet-300"
          >
            ▲ Next.js
          </motion.span>
          <motion.span
            ...
            className="absolute -bottom-4 left-1/2 -translate-x-1/2 rounded-full border border-slate-200 bg-white/90 px-3 py-1.5 text-xs font-semibold text-cyan-700 shadow-lg backdrop-blur dark:border-slate-700 dark:bg-slate-900/90 dark:text-cyan-300"
          >
            ⚡ TypeScript
          </motion.span>
        </motion.div>
