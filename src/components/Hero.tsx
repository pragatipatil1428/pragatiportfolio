    ...
    <section id="home" className="relative mx-auto flex min-h-[380px] max-w-7xl flex-col justify-center px-6 py-8 lg:px-8">
      <div className="grid items-center gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:gap-10">
        ...
        <motion.div
          ...
          className="max-w-3xl"
        >
          <div className="mb-2.5 inline-flex items-center gap-1.5 rounded-full border border-sky-200/70 bg-sky-50/80 px-2.5 py-0.5 text-[11px] font-medium text-sky-700 backdrop-blur dark:border-sky-800 dark:bg-sky-950/40 dark:text-sky-300">
            <Sparkles size={14} />
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            <a
              ...
              download
              className="inline-flex items-center gap-1.5 rounded-full bg-slate-950 px-3 py-1 text-xs font-semibold text-white transition hover:-translate-y-0.5 hover:bg-slate-800 dark:bg-sky-600 dark:hover:bg-sky-500"
            >
              <Download size={14} />
              Download Resume
            </a>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-1.5 rounded-full border border-slate-400 px-3 py-1 text-xs font-semibold text-slate-900 transition hover:-translate-y-0.5 hover:border-slate-600 hover:text-slate-950 dark:border-slate-700 dark:text-slate-200 dark:hover:text-white"
            >
              <Globe2 size={14} />
              GitHub
            </a>
          ...
          <div className="mt-4 grid gap-2.5 sm:grid-cols-3">
            {heroStats.map((stat) => (
              <div key={stat.label} className="rounded-lg border border-slate-200/80 bg-white/70 px-2.5 py-2 shadow-sm backdrop-blur dark:border-slate-800 dark:bg-slate-900/70">
        ...
        >
          <div className="absolute -inset-4 rounded-[2.5rem] bg-gradient-to-tr from-sky-500/30 via-violet-500/20 to-cyan-400/30 blur-2xl" aria-hidden />
          ...
          <motion.span
            ...
            className="absolute -left-5 top-10 rounded-full border border-slate-200 bg-white/90 px-2.5 py-1 text-[11px] font-semibold text-sky-700 shadow-lg backdrop-blur dark:border-slate-700 dark:bg-slate-900/90 dark:text-sky-300"
          >
            ⚛️ React
          </motion.span>
          <motion.span
          ...
          <motion.span
            ...
            className="absolute -bottom-3 left-1/2 -translate-x-1/2 rounded-full border border-slate-200 bg-white/90 px-2.5 py-1 text-[11px] font-semibold text-cyan-700 shadow-lg backdrop-blur dark:border-slate-700 dark:bg-slate-900/90 dark:text-cyan-300"
          >
            ⚡ TypeScript
          </motion.span>
        </motion.div>
